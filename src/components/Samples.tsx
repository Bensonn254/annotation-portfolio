...
export function Samples() {
  ...
  return (
    <section id="samples" className="py-10 md:py-20 bg-white">
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-6 xl:px-8">
        <div className="text-center mb-16">
          <div className="inline-block bg-amber-100 text-amber-700 px-4 py-2 md:py-6 rounded-full text-3xl md:text-5xl lg:text-7xl font-bold mb-6">
                ...
                <div className="relative group cursor-pointer" onClick={() => openLightbox(sample)}>
                  ...
                  <div className="relative overflow-hidden rounded-xl shadow-lg">
                    <img
                      ...
                      className={`w-full object-cover rounded-xl transition-transform duration-300 aspect-video md:aspect-auto ${sample.type === 'segmentation' ? 'md:h-96 lg:h-[500px]' : 'md:h-64 lg:h-72'}`}
                    />
